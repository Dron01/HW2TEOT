...
-- By 4E534B
-- Date: 07-25-2007 Time: 22:55:43
-- On error(s), send source (compiled) file to 4E534B@gmail.com

buildFamily={{name="Fighter_Hgn"},
	{name="Corvette_Hgn"},
	{name="Mover_Hgn"},
	{name="Frigate_Hgn"},
	{name="SuperCap_Hgn"},
	...
	{name="SuperCap_Gbr"},
	{name="SubSystem_Gbr"},};---------------------
displayFamily={{name="Fighter",
stringParam="$2100",numParam=1},	{name="Corvette",
stringParam="$2101",numParam=2},	{name="Frigate",
stringParam="$2102",numParam=3},	{name="Capital",
stringParam="$2103",numParam=4},	{name="Flagship",
stringParam="$2104",numParam=6},	{name="Platform",
stringParam="$2105",numParam=7},	{name="Utility",
stringParam="$2106",numParam=8},	{name="SubSystemModule",
stringParam="$2107",numParam=9},	{name="SubSystemSensors",
stringParam="$2108",numParam=10},	{name="Munition",
stringParam="$2109",numParam=11},	{name="Megalith",
stringParam="$2110",numParam=12}};
attackFamily={
	{name="Fighter",numParam=1},
	{name="Stormfighter",numParam=1},
	{name="Corvette",numParam=1},
	{name="HeavyCorvette",numParam=1},
	{name="Frigate",numParam=1},
	{name="HeavyFrigate",numParam=1},
...
numParam=10},
	{name="SuperPriority",
numParam=11}};
collisionFamily={{name="Small",
numParam=0},
	{name="Big",
numParam=1},
	{name="Unmoveable",
numParam=2}};
autoFormationFamily={{name="Fighter",
numParam=0},
	{name="Corvette",
numParam=1},
	{name="Frigate",
...
--	{name="DreadNaught",numParam=70,stringParam="$2120"},-----------пока вроде не нужно
...
unitcapsShipType={{name="MinelayerCorvette",numParam=11,stringParam="$2135"},
	...
	{name="Linckor",numParam=34,stringParam="линкор тобари"},
	{name="DreadNaught",numParam=35,stringParam="хиагарский дредноут"},

	{name="Shipyard",numParam=40,stringParam="$2128"},
